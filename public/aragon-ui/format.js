...
function formatTokenAmount(amount, decimals) {
  ...
  if (math.JSBI.lessThan(decimals, 0)) {
    throw new Error('formatTokenAmount(): decimals cannot be negative');
  }

  if (math.JSBI.lessThan(digits, 0)) {
  ...
  var amountConverted = math.JSBI.BigInt(math.divideRoundBigInt(amount, math.JSBI.exponentiate(_10, math.JSBI.subtract(decimals, digits))));
